        ...
        <div className="Login">
            ...
            <div className="Login-options">
                ...
                <div className="options-list">
                    <button onClick={handleEmailLogin} className="option-btn email">
                        <EmailIcon />
                        <span>Email 로그인</span>
                    </button>
                    <button onClick={() => handleSocialLogin("google")} className="option-btn google">
                        <GoogleIcon />
                        <span>Google 로그인</span>
                    </button>
                    <button onClick={() => handleSocialLogin("naver")} className="option-btn naver">
                        <NaverIcon />
                        <span>Naver 로그인</span>
                    </button>
                    <button onClick={() => handleSocialLogin("kakao")} className="option-btn kakao">
                        <KakaoIcon />
                        <span>Kakao 로그인</span>
                    </button>
                    <button onClick={() => handleSocialLogin("apple")} className="option-btn apple">
                        <AppleIcon />
                        <span>Apple 로그인</span>
                    </button>
                </div>
